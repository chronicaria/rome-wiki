...
1. [[Surface conservation laws and level-set geometry]] — connect evolving-surface transport identities to implicit geometry and conservation checks.
2. [[Reduced basis methods]] — derive offline–online decomposition and residual certification for parametric PDEs.
3. [[Hyper-reduction for nonlinear PDE models]] — explain DEIM and empirical quadrature without hiding stability loss.
