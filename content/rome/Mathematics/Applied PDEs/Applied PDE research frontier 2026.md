...
1. [[Conservation laws and entropy conditions]] — extend scalar admissibility to entropy pairs, systems, and the limits of general uniqueness theory without repeating the weak-solutions tutorial.
2. [[Discontinuous Galerkin methods]] — connect element-local weak forms, numerical fluxes, polynomial approximation, and stability in one reusable method article.
3. [[Adaptive mesh refinement]] — explain error- and feature-driven refinement, conservative coarse–fine coupling, and verification on changing meshes.
