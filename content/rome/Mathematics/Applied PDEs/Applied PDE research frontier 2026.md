...
Thirteen canonical tutorials now supply the classical spine needed to judge that frontier. The prior analysis-to-computation sequence now extends through four complementary questions. [[Stiffness and multiscale PDEs]] separates stability restrictions from accuracy and connects implicit, IMEX, exponential, multirate, and asymptotic-preserving strategies. [[Spectral methods and aliasing]] derives nonlinear wraparound and distinguishes exact dealiasing from filtering and split-form stability. [[Data assimilation as an inverse problem]] unifies Bayesian state estimation, Kalman and ensemble filters, variational methods, adjoints, model error, and verification. [[Structure-preserving numerical methods]] explains how conservation, entropy, compatible complexes, positivity, balance, symplecticity, and dissipation become distinct discrete contracts. These join [[Classifying partial differential equations]], [[Well-posedness as an applied requirement]], [[Consistency stability and convergence]], [[Conservation laws and entropy conditions]], [[Discontinuous Galerkin methods]], [[Adaptive mesh refinement]], [[Weak solutions and why shocks require them]], [[Finite-volume methods for conservation laws]], and [[Adjoint methods for PDE-constrained optimization]].
...
1. [[Uncertainty quantification for PDE models]] — separate parameter, discretization, observation, and model-form uncertainty and connect them to prediction risk.
2. [[Physics-informed neural networks and their failure modes]] — explain stiffness, spectral bias, loss imbalance, causal training, and fair solver baselines.
3. [[Primitive equations of the atmosphere]] — derive the balance and scale assumptions behind hydrostatic rotating-flow models.
