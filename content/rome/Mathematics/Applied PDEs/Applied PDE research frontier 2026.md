...
Twenty-eight canonical tutorials now supply the spine needed to judge that frontier. The newest layer derives evolving-surface transport and implicit geometry in [[Surface conservation laws and level-set geometry]], builds the certified parametric workflow of [[Reduced basis methods]], separates nonlinear sampling cost from projection in [[Hyper-reduction for nonlinear PDE models]], and identifies unresolved feedback, memory, and rollout validation in [[Closure error in reduced PDE models]]. The preceding layer explains the coarse-graining, invariance, energy-transfer, and a posteriori requirements of [[Learned closures for turbulent flows]], derives commutator-controlled coupling error in [[Operator splitting for multiphysics PDEs]], and turns primal residuals plus adjoints into output-specific indicators in [[Goal-oriented error estimation]]. Earlier layers define the function-space target and discretization claims of [[Neural operators]], derive the spectral multiplier and aliasing mechanisms of [[Fourier neural operators]], impose an end-to-end fairness ledger in [[Operator learning versus numerical solvers]], and connect projection, compression, certification, and offline–online economics in [[Reduced-order models for PDEs]]. These build on [[Uncertainty quantification for PDE models]], [[Physics-informed neural networks and their failure modes]], [[Primitive equations of the atmosphere]], [[Differentiable PDE solvers]], [[Stiffness and multiscale PDEs]], [[Spectral methods and aliasing]], [[Data assimilation as an inverse problem]], [[Structure-preserving numerical methods]], [[Classifying partial differential equations]], [[Well-posedness as an applied requirement]], [[Consistency stability and convergence]], [[Conservation laws and entropy conditions]], [[Discontinuous Galerkin methods]], [[Adaptive mesh refinement]], [[Weak solutions and why shocks require them]], [[Finite-volume methods for conservation laws]], and [[Adjoint methods for PDE-constrained optimization]].
...
1. [[Scientific machine learning benchmark design]] — make PDE benchmarks diagnostic through accuracy, compute, shift, conservation, and reproducibility ledgers.
2. [[IMEX time integration]] — derive order and stability constraints for coupled stiff and nonstiff operators.
3. [[Positivity-preserving discretizations]] — connect admissible-state constraints to fluxes, limiters, and timestep restrictions.
